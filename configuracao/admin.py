...
from configuracao.models import Curso, Provincia, Tremestre, Pais, Periodo, Grau_academico, Municipio,Genero, Resultado_Inscricao, Estado_Civil, Documento_identificacao
